...
THREE.GCodeLoader.prototype.load = function ( url, onLoad, onProgress, onError, params ) {
...
THREE.GCodeLoader.prototype.parse = function ( data, params ) {
	...
	var pathMaterial = new THREE.LineBasicMaterial( { color: 0xAAAAAA } );
	pathMaterial.name = 'path';

	var extrudingMaterial = new THREE.LineBasicMaterial( { color: 0x336af2 } );
	extrudingMaterial.name = 'extruded';

	var currentMaterial = new THREE.LineBasicMaterial( { color: 0x27cc5c } );
	...
	if ( true ) {
		if (params) {
			layers = layers.slice(params.minLayer, params.maxLayer);
		}
